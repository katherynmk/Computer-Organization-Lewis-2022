...
init
        lda #1;Default both X and Y direction is 1
        sta $02 ;Store the X direction here
        sta $03 ;Store the Y direction here


mainloop
        lda #$fb

; wait to update so sprite doesn't go crazy
wait
        cmp $d012
        bne wait

        ;Check if sprite's X is 20. If it is, go to posRevX
        lda #20
        cmp $d000
        beq posRevX

        ;Check if sprite's X is 255. If it is, go to posRevY.
        ;For some reason if I go higher than 255 it is an error,
        ;so the sprite won't go all the way to the right :(
        lda #255
        cmp $d000
        beq negRevX

        ;Check if sprite's Y is 50. If it is, go to posRevY.
        lda #50
        cmp $d001
        beq posRevY

        ;Check if sprite's Y is 230. If it is, go to negRevY.
        lda #230
        cmp $d001
        beq negRevY
continue

        ;Check the X direction. If it is 0 increase X, else decrease X.
        lda #0
        cmp $02
        bne desc
        inc $d000
...
desc
        dec $d000
con
        ;Check the Y direction. If it is 0 increase Y, else decrease Y.
        lda #0
        cmp $03
        bne descY
        inc $d001
...
;Make the direction of the sprite go to the right.
posRevX
        lda #0
        sta $02
        jmp continue

;Make the direction of the sprite go to the left.
negRevX
        lda #1
        sta $02
        jmp continue

;Make the direction of the sprite go up.
posRevY
        lda #0
        sta $03
        jmp continue

;Make the direction of the sprite go down.
negRevY
        lda #1
        sta $03
        jmp continue
...
*=$0A00
; sprite #0
        BYTE $00, $00, $00, $03, $0C, $00, $03, $1C, $00, $03, $1C, $00, $03, $38, $00, $03, $70, $00, $03, $E0, $00
        BYTE $03, $C2, $40, $03, $82, $40, $03, $82, $C0, $03, $C3, $80, $03, $E3, $00, $03, $63, $00, $03, $73, $80
        BYTE $03, $3A, $C0, $03, $3A, $40, $03, $1E, $60, $03, $1E, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00
        BYTE 0
